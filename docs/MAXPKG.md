...
- `skills\max-ultra-mcp` and `skills\max-ultra-floor-plan` are the optional file-based agent skills shipped with the package; MCP operation does not depend on installing them.
