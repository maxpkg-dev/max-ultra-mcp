...
const tools = [
  ...
  tool("max_execute", "Execute unrestricted MaxScript. Prefer semantic tools when available. A specific activity name is required and is shown in the 3ds Max log.", schema({ script: { type: "string", minLength: 1 }, activity: { type: "string", minLength: 3, maxLength: 80, description: "Required exact imperative English operation name shown in the 3ds Max activity log, such as Create wall openings, Assign tree materials, or Delete opening helpers. Generic labels, code, filenames, and paths are rejected." }, timeout_ms: { type: "integer", minimum: 1000, maximum: MAX_EXECUTION_TIMEOUT_MS, default: 60000 } }, ["script", "activity"]), openWrite),
  tool("max_run_script", "Execute MaxScript text and return its value, type, character count, and bounded truncation status up to 500,000 characters. A specific activity name is required and is shown in the 3ds Max log.", schema({ script: { type: "string", minLength: 1 }, activity: { type: "string", minLength: 3, maxLength: 80, description: "Required exact imperative English operation name shown in the 3ds Max activity log, such as Create wall openings, Assign tree materials, or Delete opening helpers. Generic labels, code, filenames, and paths are rejected." }, timeout_ms: { type: "integer", minimum: 1000, maximum: MAX_EXECUTION_TIMEOUT_MS, default: 60000 } }, ["script", "activity"]), openWrite),
  tool("max_run_script_file", "Execute a local .ms or .mse file inside 3ds Max. A specific activity name is required and is shown in the 3ds Max log.", schema({ filePath: { type: "string", minLength: 1 }, activity: { type: "string", minLength: 3, maxLength: 80, description: "Required exact imperative English operation name shown in the 3ds Max activity log. Generic labels, code, filenames, and paths are rejected." }, timeout_ms: { type: "integer", minimum: 1000, maximum: MAX_EXECUTION_TIMEOUT_MS, default: 60000 } }, ["filePath", "activity"]), openWrite),
