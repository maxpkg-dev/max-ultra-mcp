...
function renderMarkdown(markdown, { relativePath = "SKILL.md", title = "Skill preview", notice = "", navigation = false, theme = "dark", background, foreground, buttonBackground, buttonHover } = {}) {
  let details = "";
  let body = markdown;
