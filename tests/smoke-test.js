...
async function runSmokeTest() {
  ...
  try {
    ...
    assert.ok(bootstrapSource.includes(`label lblAboutVersion "Version: ${PACKAGE_VERSION}"`));
    ...
    assert.ok(bootstrapSource.includes(`3DGROUND - Max Ultra MCP ${PACKAGE_VERSION}`));
