...
async function runSmokeTest() {
  ...
  try {
    ...
    assert.match(bootstrapSource, /fn styleButton buttonControl[\s\S]*FlatStyle"\)\.Flat[\s\S]*MouseOverBackColor[\s\S]*MouseDownBackColor/);
    ...
    assert.match(bootstrapSource, /fn styleLink linkControl = \([\s\S]*inheritParentBackColor linkControl fallbackColor: theme\.rolloutColor[\s\S]*LinkBehavior"\)\.HoverUnderline[\s\S]*TabStop = true/);
    ...
    assert.match(refreshUiBody, /serverStatusDialog\.lblEndpoint\.AccessibleDescription = endpointText/);
    assert.match(refreshUiBody, /serverStatusDialog\.lblContext\.AccessibleDescription = contextText/);
    assert.match(refreshUiBody, /panelToolTip\.SetToolTip serverStatusDialog\.lblEndpoint endpointText[\s\S]*panelToolTip\.SetToolTip serverStatusDialog\.lblContext contextText/);
    ...
    assert.match(activityDisplayTextBody, /local outputText = activityText\(\)[\s\S]*return outputText \+ activityBottomPadding/);
