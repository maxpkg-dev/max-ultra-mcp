@rem Lists every 3ds Max instance currently connected to Max Ultra MCP.
...
title 3DGROUND - Max Ultra MCP - List Instances
cls
echo ================================================================
echo   3DGROUND ^| MAX ULTRA MCP
echo   READ-ONLY EXAMPLE - LIST CONNECTED 3DS MAX INSTANCES
echo ================================================================
echo.
